...
with col2:
    ...
    st.write("### 2.- Click :green[**Load data**] to update your current dataframe :red[before] running any analysis.")
    st.write("### 3.- If an streamlit :red[error] ocurrs make sure to click :green[Load data] in sidebar.")
    ""  # Add some space.
    ""  # Add some space.
    ""  # Add some space.
    col1, col2, col3 = st.columns([1,2,1])
